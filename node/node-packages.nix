...
in
{
  aws-azure-login = nodeEnv.buildNodePackage {
    ...
    version = "2.1.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/aws-azure-login/-/aws-azure-login-2.1.0.tgz";
      sha512 = "TYd6rgLDdJ41aU96dMd9v5Lbl+HdWqfwUafzwoKTJ7oohS4Qu7EB0JJl3ExPoqwod4SIJg3saPhvBOTK405RvQ==";
    };
    dependencies = [
